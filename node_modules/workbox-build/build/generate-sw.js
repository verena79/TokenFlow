...
async function generateSW(config) {
    const options = validate_options_1.validateGenerateSWOptions(config);
    let entriesResult;
    if (options.globDirectory) {
        ...
        entriesResult = await get_file_manifest_entries_1.getFileManifestEntries(options);
    }
    else {
        entriesResult = {
            count: 0,
    ...
    const filePaths = await write_sw_using_default_template_1.writeSWUsingDefaultTemplate(Object.assign({
